...
add wave -radix decimal sim:/processor/port_in
add wave -radix decimal sim:/processor/port_out
...
run 
run 
force -freeze sim:/processor/port_in 32'h5 0
run 
force -freeze sim:/processor/port_in 32'h19 0
run
force -freeze sim:/processor/port_in 32'hfffd 0
run
force -freeze sim:/processor/port_in 32'hF320 0
run
run
run
run
