...
force -freeze sim:/processor/port_in 32'h30 0
run
force -freeze sim:/processor/port_in 32'h50 0
run
force -freeze sim:/processor/port_in 32'h100 0
run
force -freeze sim:/processor/port_in 32'h300 0
run
force -freeze sim:/processor/port_in 32'hFFFFFFFF 0
run
run
run
run
run
run
force -freeze sim:/processor/interrupt_signal 1 0
run
force -freeze sim:/processor/interrupt_signal 0 0
run
run
...
force -freeze sim:/processor/port_in 32'h200 0
run
run
run
run
